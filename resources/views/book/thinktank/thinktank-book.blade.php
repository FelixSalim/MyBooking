...
@section('title', 'Thinktank Room - MyBooking')
@section('page-title', 'Thinktank Room')
    ...
    <div class="booking-container">
        <div class="booking-card">
            ...
            <div class="booking-form">
                ...
                <form action="{{ route('thinktank.bookings.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-actions">
                        <a href="{{ route('rooms.show', 'Thinktank') }}" class="cancel">Cancel</a>
