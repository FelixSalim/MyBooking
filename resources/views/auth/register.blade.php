...
<head>
    ...
    <title>MyBooking - Register</title>
    ...
    <div class="container-fluid d-flex p-0">
        ...
        <div class="col-md-6 right-side">
            ...
            <div class="register-box">
                <!-- "Create an Account here" inside the box -->
                <div class="register-title">Create an Account here</div>
                ...
                <form method="POST" action="{{ route('register.post') }}">
                    ...
                    <div class="mb-3 text-start">
                        <label class="form-label" for="password">
                            Enter Password <span class="required">*</span>
                        </label>
                    ...
                    <div class="mb-3 text-start">
                        ...
                        <input type="password" name="password_confirmation" class="form-control" placeholder="Type your password ex. 123456" required>
                    </div>
