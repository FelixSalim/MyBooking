...
class BookingController extends Controller
{
    ...
    public function store_ampitheatre(Request $request)
    {
        $request->validate([
            'room_id' => 'required|exists:rooms,id',
            'booking_date' => 'required|date|afterOrEqual:today',
        ...
        return redirect()->route('home')->with('success', 'Ampitheatre booking created successfully!');
    }

    public function store_thinktank(Request $request)
    {
        $request->validate([
            'room_id' => 'required|exists:rooms,id',
            'booking_date' => 'required|date|afterOrEqual:today',
